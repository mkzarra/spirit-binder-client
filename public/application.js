...
var spiritApi = __webpack_require__(6);
var getFormFields = __webpack_require__(8);
var spiritUi = __webpack_require__(10);

var activateCreateFields = function activateCreateFields(event) {
...
var activateUpdateFields = function activateUpdateFields(event) {
  event.preventDefault();
...
var onEngageSignUpModal = function onEngageSignUpModal(event) {
  event.preventDefault();
  $('#signUpModal').modal('show');
};

var onEngageSignInModal = function onEngageSignInModal(event) {
  event.preventDefault();
  $('#signInModal').modal('show');
};

var onEngagePasswordChangeModal = function onEngagePasswordChangeModal(event) {
  event.preventDefault();
...
var onSignUp = function onSignUp(event) {
  ...
  spiritApi.signUp(data).then(spiritUi.onSignUpSuccess).catch(spiritUi.onSignUpFailure);
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  spiritApi.signIn(data).then(spiritUi.onSignInSuccess).catch(spiritUi.onSignInFailure);
  $('#signInModal').modal('hide');
};

var onSignOut = function onSignOut(event) {
  event.preventDefault();
  spiritApi.signOut().then(spiritUi.onSignOutSuccess).catch(spiritUi.onSignOutFailure);
};

var onChangePassword = function onChangePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  spiritApi.changePassword(data).then(spiritUi.onChangePasswordSuccess).catch(spiritUi.onChangePasswordFailure);
};

var onSearchByName = function onSearchByName(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  spiritApi.searchByName(data).then(spiritUi.onSearchSuccess).then(spiritUi.onSearchFailure);
};

var onGetBottles = function onGetBottles(event) {
  event.preventDefault();
  spiritApi.getBottles().then(spiritUi.onGetBottlesSuccess).catch(spiritUi.onGetBottlesFailure);
};

var onFindBottle = function onFindBottle(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  spiritApi.findBottle(data.whiskeys.id).then(spiritUi.onFindBottleSuccess).catch(spiritUi.onFindBottleFailure);
};

var onCreateBottle = function onCreateBottle(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var whiskeys = data.whiskeys;
  if (whiskeys.name === '') {
  ...
  if (whiskeys.description === '') {
    ...
    spiritApi.createBottle(data).then(spiritUi.onCreateSuccess).catch(spiritUi.onCreateError);
  }
};

var onDeleteBottle = function onDeleteBottle(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  spiritApi.destroyBottle(data.whiskeys.id).then(spiritUi.onDeleteSuccess).catch(spiritUi.onDeleteFailure);
};

var onUpdateBottle = function onUpdateBottle(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var whiskeys = data.whiskeys;
  if (whiskeys.name === '') {
  ...
  if (whiskeys.id.length !== 0) {
    spiritApi.updateBottle(data).then(spiritUi.onUpdateBottleSuccess).catch(spiritUi.onUpdateBottleFailure);
  }
};

module.exports = {
  activateCreateFields: activateCreateFields,
  activateUpdateFields: activateUpdateFields,
  onEngageSignUpModal: onEngageSignUpModal,
  onEngageSignInModal: onEngageSignInModal,
  onEngagePasswordChangeModal: onEngagePasswordChangeModal,
  onSignUp: onSignUp,
  onSignIn: onSignIn,
  onSignOut: onSignOut,
  onChangePassword: onChangePassword,
  onSearchByName: onSearchByName,
  onGetBottles: onGetBottles,
  onFindBottle: onFindBottle,
...
var searchByName = function searchByName(data) {
  return $.ajax({
...
var getBottles = function getBottles() {
  return $.ajax({
    url: config.apiUrl + '/whiskeys',
    method: 'GET',
    headers: {
...
var findBottle = function findBottle(id) {
  return $.ajax({
...
var createBottle = function createBottle(data) {
  return $.ajax({
    url: config.apiUrl + '/whiskeys/',
    method: 'POST',
    headers: {
...
var destroyBottle = function destroyBottle(id) {
  return $.ajax({
    url: config.apiUrl + '/whiskeys/' + id,
    method: 'DELETE',
    headers: {
...
var updateBottle = function updateBottle(data) {
  return $.ajax({
...
module.exports = {
  ...
  findBottle: findBottle,
  createBottle: createBottle,
  destroyBottle: destroyBottle,
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://spiritbinder.herokuapp.com',
...
var renderWhiskeys = function renderWhiskeys(data) {
  $('.clear-index').css('display', 'none');
  data.whiskeys.forEach(function (whiskeys) {
...
var clearFormFields = function clearFormFields(formId) {
...
var onSearchSuccess = function onSearchSuccess(data) {
  $('#message').css('display', 'none');
  renderWhiskeys(data);
};

var onSearchFailure = function onSearchFailure(error) {
  $('#message').text('Could not find what you\'re looking for: ' + error);
};

var onGetBottlesSuccess = function onGetBottlesSuccess(data) {
  $('#message').css('display', 'none');
  renderWhiskeys(data);
};

var onGetBottlesFailure = function onGetBottlesFailure(error) {
  $('#message').text('Unable to show bottles. Try a less specific search');
  $('#message').css('color', 'red');
  $('#message').text('failure on get bottles: ' + error);
};

var onFindBottleSuccess = function onFindBottleSuccess(data) {
  $('.clear-index').css('display', 'none');
  var whiskey = data.whiskey;
...
var onFindBottleFailure = function onFindBottleFailure(error) {
...
var onUpdateBottleSuccess = function onUpdateBottleSuccess(data) {
  $('.clear-index').css('display', 'none');
  var whiskey = data.whiskey;
...
var onUpdateBottleFailure = function onUpdateBottleFailure(error) {
...
module.exports = {
  ...
  onGetBottlesSuccess: onGetBottlesSuccess,
  onGetBottlesFailure: onGetBottlesFailure,
  onFindBottleSuccess: onFindBottleSuccess,
  onFindBottleFailure: onFindBottleFailure,
  onCreateSuccess: onCreateSuccess,
  onCreateFailure: onCreateFailure,
  onDeleteSuccess: onDeleteSuccess,
  onDeleteFailure: onDeleteFailure,
  onUpdateBottleSuccess: onUpdateBottleSuccess,
  onUpdateBottleFailure: onUpdateBottleFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
